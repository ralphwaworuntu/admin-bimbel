        ...
        <div className="space-y-8 lg:space-y-12 pb-32">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center gap-2 shrink-0">
                    <button className="px-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-[10px] font-black flex items-center gap-2 shadow-sm hover:bg-slate-50 transition-all uppercase tracking-widest">
                ...
                {[
                    ...
                    <Link key={stat.label} href={stat.href}>
                        <motion.div
                            ...
                            className="bg-white dark:bg-slate-900 p-6 lg:p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm group hover:border-primary-brand/30 transition-all relative overflow-hidden h-full"
                        >
                            <div className="relative z-10">
                                <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-2xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-slate-400 group-hover:text-primary-brand transition-colors mb-6 border border-slate-100 dark:border-slate-700">
            ...
            <div className="grid grid-cols-1 2xl:grid-cols-3 gap-6 lg:gap-10">
                ...
                <div className="2xl:col-span-2 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[2rem] lg:rounded-[3rem] p-6 lg:p-10 shadow-sm min-h-[400px] lg:h-[500px] flex flex-col">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8 text-center sm:text-left">
                        <div>
                            ...
                            <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400 mt-1">Aggregated Distribution</p>
                        </div>
                ...
                <div className="2xl:col-span-1 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[2rem] lg:rounded-[3rem] p-6 lg:p-10 shadow-sm flex flex-col justify-between min-h-[400px]">
                    <div>
                            ...
                            {trafficSourceData.map((source, i) => (
                                ...
                                >
                                    <div className="space-y-2">
                                        <div className="flex items-center justify-between text-[9px] font-black uppercase tracking-widest text-slate-500 group-hover/source:text-primary-brand transition-colors">
                                            <span className="truncate">{source.name}</span>
                                            <span className="text-slate-900 dark:text-white shrink-0">{source.value}%</span>
                                        </div>
                    ...
                    <Link href="/dashboard/economics">
                        <div className="mt-10 p-6 bg-slate-50 dark:bg-slate-800/80 rounded-[1.5rem] border border-slate-100 dark:border-slate-700 relative overflow-hidden group cursor-pointer hover:border-primary-brand/30 transition-all">
                            <div className="flex items-start gap-4 relative z-10">
                                <TrendingUp className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                                <div className="min-w-0">
                                    <p className="text-[9px] font-black uppercase text-slate-400 tracking-widest mb-1">Recommendation</p>
                                    <p className="text-[11px] font-bold text-slate-600 dark:text-slate-300 leading-relaxed">Boost social ad spend in APAC regions to exploit high-ROI anomalies Detected.</p>
                                </div>
                            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-10">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-[2rem] lg:rounded-[3rem] p-8 lg:p-10 border border-slate-100 dark:border-slate-800 shadow-sm flex flex-col min-h-[450px]">
                    <div className="mb-10">
                        <h3 className="text-xl font-black tracking-tight">Conversion Funnel</h3>
                        <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400 mt-1">Sovereign Journey Analysis</p>
                    </div>
                    <div className="space-y-3 lg:space-y-4 flex-1">
                        {[
                            { step: "Awareness", users: "125k", width: "100%", opacity: "bg-slate-100 dark:bg-slate-800" },
                            ...
                            <Link key={i} href="/dashboard/customers" className="relative group h-14 lg:h-16 block">
                                <div className={`h-full w-full rounded-2xl border border-slate-100 dark:border-slate-800 ${item.opacity} overflow-hidden transition-all group-hover:ring-1 group-hover:ring-primary-brand/30 shadow-sm`}>
                                    <motion.div
                                        initial={{ width: 0 }}
