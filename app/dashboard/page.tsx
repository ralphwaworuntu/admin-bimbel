...
export default function DashboardOverview() {
    ...
    return (
        <div className="space-y-8 lg:space-y-12 pb-32">
            ...
            <div className="bg-zinc-950 border border-white/10 rounded-[2rem] lg:rounded-[2.5rem] p-6 lg:p-8 flex flex-col xl:flex-row items-center justify-between gap-8 shadow-2xl relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between relative z-10 w-full xl:w-auto">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3 mt-1 group/health relative">
                                <Link href="/nexus" className="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity">
                                    <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Autonomous Health:</span>
                                ...
                                {/* Health Infotip */}
                                <div className="absolute top-full left-0 mt-4 w-64 p-4 bg-zinc-900 border border-white/10 rounded-2xl shadow-2xl opacity-0 translate-y-2 pointer-events-none group-hover/health:opacity-100 group-hover/health:translate-y-0 group-hover/health:pointer-events-auto transition-all z-50">
                                    <p className="text-[10px] font-bold text-zinc-400 mb-2 uppercase tracking-widest">Health Analysis</p>
                    ...
                    <button
                        ...
                        className="xl:hidden w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white transition-all shadow-xl"
                    >
                ...
                <div className="flex-1 w-full grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8 relative z-10 xl:px-8 border-t xl:border-t-0 xl:border-l border-white/10 pt-8 xl:pt-0">
                    <Link href="/dashboard/deployments" className="flex flex-col group/stat cursor-pointer hover:bg-white/5 p-2 rounded-xl transition-all relative">
                        <span className="text-[9px] lg:text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1">Sites Live</span>
                    ...
                    <Link href="/dashboard/analytics" className="flex flex-col group/stat cursor-pointer hover:bg-white/5 p-2 rounded-xl transition-all">
                        <span className="text-[9px] lg:text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1">Weekly Reach</span>
                    ...
                    <Link href="/dashboard/guardian" className="flex flex-col hidden md:flex group/stat cursor-pointer hover:bg-white/5 p-2 rounded-xl transition-all">
                        <span className="text-[9px] lg:text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1">Infrastructure</span>
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 mb-1">
                            <span className="text-[9px] font-black text-zinc-400 uppercase tracking-widest">Quick HUD</span>
                        </div>
                        <span className="text-[9px] font-black text-white bg-zinc-800 px-2 py-0.5 rounded-md border border-white/10 opacity-60 group-hover:opacity-100 transition-opacity tracking-widest">CMD+K</span>
                    </button>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6 lg:gap-8">
                    {allSites.map((site, i) => (
                        <motion.div
                            ...
                            className="bg-white dark:bg-zinc-900 rounded-[2rem] border border-zinc-100 dark:border-zinc-800 overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all group flex flex-col cursor-pointer"
                            onClick={() => setSelectedSite(site)}
                        >
                            <div className="bg-zinc-100 dark:bg-zinc-800 aspect-[16/10] relative overflow-hidden">
                                <div className="absolute inset-0 bg-white dark:bg-zinc-900 border-b border-zinc-100 dark:border-zinc-800 p-6 flex flex-col justify-center">
                                    ...
                                    <div className="space-y-3">
                                        <div className="w-full h-10 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl"></div>
                                        <div className="w-2/3 h-2 bg-zinc-50 dark:bg-zinc-800/50 rounded-full"></div>
                                    </div>
                                </div>
                                ...
                                <div className="absolute inset-0 bg-primary-brand/10 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 backdrop-blur-sm">
                                    <button
                                        className="px-5 py-2.5 bg-white dark:bg-zinc-900 text-[9px] font-black uppercase tracking-widest rounded-xl shadow-lg hover:scale-110 transition-all font-black"
                                        onClick={(e) => {
                                            e.stopPropagation();
                                ...
                                <div className="absolute top-4 left-4 flex flex-col gap-2">
                                    ...
                                    {site.region && (
                                        <div className="px-3 py-1.5 rounded-xl text-[8px] font-black uppercase tracking-widest shadow-xl flex items-center gap-1.5 bg-zinc-900 text-white border border-white/10">
                            ...
                            <div className="p-6 lg:p-8 flex-1 flex flex-col">
                                <div className="flex items-start justify-between mb-6 gap-4">
                                    <div className="min-w-0">
                                        ...
                                        <p className="text-[10px] font-bold text-zinc-400 truncate">{site.url}</p>
                                    </div>
                                    <div className="w-10 h-10 rounded-xl bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center border border-zinc-100 dark:border-zinc-700 shrink-0">
                                        <Globe className="w-4 h-4 text-zinc-400" />
                                    </div>
                                </div>
                                <div className="grid grid-cols-2 gap-3 mt-auto">
                                    <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-zinc-800/40 border border-zinc-100 dark:border-zinc-700">
                                        <p className="text-[8px] font-black text-zinc-400 uppercase tracking-widest mb-1 truncate">Visits</p>
                                        <p className="text-xs font-black">{site.visits}</p>
                                    </div>
                                    <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-zinc-800/40 border border-zinc-100 dark:border-zinc-700">
                                        <p className="text-[8px] font-black text-zinc-400 uppercase tracking-widest mb-1 truncate">Latency</p>
                    ...
                    <Link href="/wizard" className="bg-zinc-50 dark:bg-zinc-950 border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-[2rem] flex flex-col items-center justify-center gap-6 p-8 min-h-[350px] hover:border-primary-brand hover:bg-primary-brand/5 transition-all group cursor-pointer">
                        <div className="w-16 h-16 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center text-zinc-300 group-hover:text-primary-brand group-hover:scale-110 transition-all shadow-sm">
                            <Plus className="w-6 h-6" />
                        </div>
                        <div className="text-center">
                            <p className="text-base font-black tracking-tight mb-1">Synthesize Site</p>
                            <p className="text-[10px] font-bold text-zinc-400 max-w-[120px] mx-auto leading-relaxed">Begin new autonomous deployment</p>
                        </div>
                    </Link>
                </div>
            </div>
                ...
                {selectedSite && (
                    <>
                        <motion.div
                            ...
                            className="fixed inset-0 bg-zinc-950/60 backdrop-blur-md z-[100] cursor-default"
                        />
                        <motion.div
                            initial={{ x: "100%" }}
                            animate={{ x: 0 }}
                            ...
                            className="fixed right-0 top-0 bottom-0 w-full max-w-xl bg-white dark:bg-[#020617] border-l border-zinc-100 dark:border-white/10 z-[101] flex flex-col shadow-[-30px_0_100px_rgba(0,0,0,0.3)]"
                        >
                            <div className="p-8 lg:p-12 border-b border-zinc-100 dark:border-white/5 flex items-center justify-between shrink-0">
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs font-bold text-zinc-400 mt-1">{selectedSite.url}</p>
                                    </div>
                                </div>
                                <button
                                    onClick={() => setSelectedSite(null)}
                                    className="w-12 h-12 rounded-xl bg-zinc-50 dark:bg-white/5 flex items-center justify-center text-zinc-400 hover:text-primary-brand transition-all"
                                >
                                    <X className="w-6 h-6" />
                                </button>
                            </div>
                            ...
                            <div className="flex-1 overflow-y-auto p-8 lg:p-12 space-y-12 custom-scrollbar">
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="p-5 rounded-[1.5rem] bg-zinc-50 dark:bg-white/5 border border-zinc-100 dark:border-white/5">
                                        <p className="text-[9px] font-black text-zinc-400 uppercase tracking-widest mb-2">Conversion Score</p>
                                        <p className="text-lg font-black text-primary-brand">{selectedSite.score || "84"}%</p>
                                    </div>
                                    <div className={`p-5 rounded-[1.5rem] bg-zinc-50 dark:bg-white/5 border border-zinc-100 dark:border-white/5`}>
                                        <p className="text-[9px] font-black text-zinc-400 uppercase tracking-widest mb-2">Market Pulse</p>
                                        <p className="text-lg font-black uppercase tracking-tight">{selectedSite.region || "Global"}</p>
                                    </div>
                                    <div className="p-5 rounded-[1.5rem] bg-zinc-50 dark:bg-white/5 border border-zinc-100 dark:border-white/5">
                                        <p className="text-[9px] font-black text-zinc-400 uppercase tracking-widest mb-2">Uptime</p>
                                        <p className="text-lg font-black text-emerald-500">{selectedSite.uptime || "100%"}</p>
                                    </div>
                                    <div className="p-5 rounded-[1.5rem] bg-zinc-50 dark:bg-white/5 border border-zinc-100 dark:border-white/5">
                                        <p className="text-[9px] font-black text-zinc-400 uppercase tracking-widest mb-2">Latency</p>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-zinc-950 rounded-3xl p-6 font-mono text-[11px] leading-relaxed space-y-2 border border-white/5">
                                        <p className="text-emerald-500/80">[SYSTEM] Connection established to Edge-SG-1</p>
                                        <p className="text-zinc-500">{"2026-02-12 00:54:12"} {"->"} GET /index.html 200 OK (12ms)</p>
                                        <p className="text-zinc-500">{"2026-02-12 00:54:13"} {"->"} API request to /graph/v1/sites</p>
                                        <p className="text-blue-400/80">[AUDIT] L7 Firewall scrubbed incoming request (ID: #X921)</p>
                                        <p className="text-zinc-500">{"2026-02-12 00:54:15"} {"->"} Cache Hit: asset/main.css (0ms)</p>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 gap-3">
                                        <Link href="/dashboard/settings" className="flex items-center justify-between p-5 rounded-2xl bg-zinc-50 dark:bg-white/5 border border-zinc-100 dark:border-white/5 hover:border-primary-brand transition-all text-left">
                                        ...
                                        <button className="flex items-center justify-between p-5 rounded-2xl bg-zinc-50 dark:bg-white/5 border border-zinc-100 dark:border-white/5 hover:border-red-500/50 transition-all text-left group">
                                            <div className="flex items-center gap-4 text-zinc-400 group-hover:text-red-500 transition-colors">
                                                <Shield className="w-5 h-5" />
                                                <span className="text-xs font-black uppercase tracking-widest">Purge Domain</span>
                                            </div>
                                            <ChevronRight className="w-4 h-4 text-zinc-300 group-hover:text-red-500 transition-colors" />
                                        </button>
                                    </div>
                                </div>
                            </div>

                            <div className="p-8 lg:p-12 border-t border-zinc-100 dark:border-white/5 bg-zinc-50 dark:bg-white/2 flex gap-4">
                                ...
                                <button
                                    className="px-6 bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-white py-4 rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-all"
